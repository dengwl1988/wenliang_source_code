...
public class Test7 extends Applet implements ActionListener, MouseListener,
MouseMotionListener, ItemListener{
  int color_Qizi = 0;// 旗子的颜色标识 0:白子 1:黑子
  int intGame_Start = 0;// 游戏开始标志 0未开始 1游戏中
  int intGame_Body[][] = new int[10][10];//设置棋盘棋子状态 0无子 1 白子 2黑子
	Button b1 = new Button("启动游戏");
	Button b2 = new Button("游戏重新开始");
	...
	add(b1);
	b1.setBounds(230, 50, 80, 30);
	b1.addActionListener(this);
	add(b2);
	b2.setBounds(230, 90, 80, 30);
	b2.addActionListener(this);
	ckbHB[0] = new Checkbox("白子先", ckgHB, false);
	ckbHB[0].setBounds(220, 20, 60, 30);
	ckbHB[1] = new Checkbox("黑子先",ckgHB, false);
	ckbHB[1].setBounds(280, 20, 60, 30);
	add(ckbHB[0]);
	add(ckbHB[1]);
...
lblWin.setText(Get_qizi_color(color_Qizi) + "win!");
	...
	G.fill3DRect(10, 10, 180, 180, true);
	G.setColor(Color.black);
	for (int i = 1; i < 10; i++) {
	G.drawLine(20, 20 * i, 180, 20 * i);
	G.drawLine(20 * i, 20, 20 * i, 180);
	}
	}
